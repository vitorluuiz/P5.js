...
class CustomPeer {
    ...
    onConnection(conn) {
        conn.on('open', () => {
            ...
            if (this.isHost) {
                ...
                fetch(`${API_ROUTE}/rooms/room/${this.myPeer._id}/playerJoin`, {
    ...
    onDisconnection(idPeer) {
        ...
        if (this.isHost) {
            ...
            fetch(`${API_ROUTE}/rooms/room/${this.myPeer._id}/playerLeft`, {
                headers: { 'Content-Type': 'application/json' },
                method: 'PATCH',
        ...
        if (idPeer === this.firstConn()) {
            ...
            if (this.isSubHost) {
                ...
                // Remove the peer from the room in the rooms server
                fetch(`${API_ROUTE}/rooms/room/${idPeer}/playerLeft`, {
                    headers: { 'Content-Type': 'application/json' },
                    method: 'PATCH',
                    body: JSON.stringify({ playerName: idPeer, playerId: idPeer })
                });
                ...
                fetch(`${API_ROUTE}/rooms/room/${idPeer}`, {
                    headers: { 'Content-Type': 'application/json' },
                    method: 'PATCH',
